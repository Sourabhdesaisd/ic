...
input 		  [15:0] 	int0_lp_i			              ,//interrupt level priority value
input 		  [15:0] 	int1_lp_i			              ,
input 		  [15:0] 	int2_lp_i			              ,
input 		  [15:0] 	int3_lp_i			              ,
input 		  [15:0] 	int4_lp_i			              ,
input 		  [15:0] 	int5_lp_i			              ,
input 		  [15:0] 	int6_lp_i			              ,
input 		  [15:0] 	int7_lp_i			              ,
input 		  [15:0] 	int8_lp_i			              ,
input 		  [15:0] 	int9_lp_i			              ,
input 		  [15:0] 	int10_lp_i			            ,
input 		  [15:0] 	int11_lp_i			            ,
input 		  [15:0] 	int12_lp_i			            ,
input 		  [15:0] 	int13_lp_i			            ,
input 		  [15:0] 	int14_lp_i			            ,
input 		  [15:0] 	int15_lp_i			            ,
...
assign int0_lp_w      =int_pending_i[0 ] ?  int0_lp_i[15:8] : 8'd0;	
assign int1_lp_w      =int_pending_i[1 ] ?  int1_lp_i[15:8] : 8'd0;	
assign int2_lp_w      =int_pending_i[2 ] ?  int2_lp_i[15:8] : 8'd0;	
assign int3_lp_w      =int_pending_i[3 ] ?  int3_lp_i[15:8] : 8'd0;	
assign int4_lp_w      =int_pending_i[4 ] ?  int4_lp_i[15:8] : 8'd0;	
assign int5_lp_w      =int_pending_i[5 ] ?  int5_lp_i[15:8] : 8'd0;	
assign int6_lp_w      =int_pending_i[6 ] ?  int6_lp_i[15:8] : 8'd0;	
assign int7_lp_w      =int_pending_i[7 ] ?  int7_lp_i[15:8] : 8'd0;	
assign int8_lp_w      =int_pending_i[8 ] ?  int8_lp_i[15:8] : 8'd0;	
assign int9_lp_w      =int_pending_i[9 ] ?  int9_lp_i[15:8] : 8'd0;	
assign int10_lp_w	  =int_pending_i[10] ? int10_lp_i[15:8] : 8'd0;
assign int11_lp_w	  =int_pending_i[11] ? int11_lp_i[15:8] : 8'd0;
assign int12_lp_w	  =int_pending_i[12] ? int12_lp_i[15:8] : 8'd0;
assign int13_lp_w	  =int_pending_i[13] ? int13_lp_i[15:8] : 8'd0;
assign int14_lp_w	  =int_pending_i[14] ? int14_lp_i[15:8] : 8'd0;
assign int15_lp_w	  =int_pending_i[15] ? int15_lp_i[15:8] : 8'd0;
...
.val_in_1	(int0_lp_w  ),
.val_in_2	(int1_lp_w  ),
.val1_id    (int0_lp_i[7:0]   ),
.val2_id    (int1_lp_i[7:0]   ),
.out_id     (stage_id0_0),
.val_out	(stage0_0   )
);
...
.val_in_1	(int2_lp_w  ),
.val_in_2	(int3_lp_w  ),
.val1_id    (int2_lp_i[7:0]    ),
.val2_id    (int3_lp_i[7:0]    ),
.out_id     (stage_id0_1),
.val_out	(stage0_1   )
);
...
.val_in_1	(int4_lp_w  ),
.val_in_2	(int5_lp_w  ),
.val1_id    (int4_lp_i[7:0]    ),
.val2_id    (int5_lp_i[7:0]    ),
.out_id     (stage_id0_2),
.val_out	(stage0_2   )
);
...
.val_in_1	(int6_lp_w  ),
.val_in_2	(int7_lp_w  ),
.val1_id    (int6_lp_i[7:0]    ),
.val2_id    (int7_lp_i[7:0]    ),
.out_id     (stage_id0_3),
.val_out	(stage0_3   )
);
...
.val_in_1	(int8_lp_w  ),
.val_in_2	(int9_lp_w  ),
.val1_id    (int8_lp_i[7:0]    ),
.val2_id    (int9_lp_i[7:0]    ),
.out_id     (stage_id0_4),
.val_out	(stage0_4   )
);
...
.val_in_1	(int10_lp_w  ),
.val_in_2	(int11_lp_w  ),
.val1_id    (int10_lp_i[7:0]    ),
.val2_id    (int11_lp_i[7:0]    ),
.out_id     (stage_id0_5 ),
.val_out	(stage0_5    )
);
...
.val_in_1	(int12_lp_w  ),
.val_in_2	(int13_lp_w  ),
.val1_id    (int12_lp_i[7:0]   ),
.val2_id    (int13_lp_i[7:0]   ),
.out_id     (stage_id0_6 ),
.val_out	(stage0_6    )
);
...
.val_in_1	(int14_lp_w  ),
.val_in_2	(int15_lp_w  ),
.val1_id    (int14_lp_i[7:0]   ),
.val2_id    (int15_lp_i[7:0]   ),
.out_id     (stage_id0_7 ),
.val_out	(stage0_7    )
);
