...
input 		[7:0]soc_mmr_write_data_i	,
input 		soc_mmr_read_en_i	,
input 		[15:0]soc_mmr_read_addr_i	,
output 		[7:0]soc_mmr_read_data_o	,
//////////////////////////////////////////
//signals to soc 
output [15:0] 	irq0_ctrl_o		,// [7:0] - soc_ip
output [15:0] 	irq1_ctrl_o		,
output [15:0] 	irq2_ctrl_o		,
output [15:0] 	irq3_ctrl_o		,
output [15:0] 	irq4_ctrl_o		,
output [15:0] 	irq5_ctrl_o		,
output [15:0] 	irq6_ctrl_o		,
output [15:0] 	irq7_ctrl_o		,
output [15:0] 	irq8_ctrl_o		,
output [15:0] 	irq9_ctrl_o		,
output [15:0] 	irq10_ctrl_o		,
output [15:0] 	irq11_ctrl_o		,
output [15:0] 	irq12_ctrl_o		,
output [15:0] 	irq13_ctrl_o		,
output [15:0] 	irq14_ctrl_o		,
output [15:0] 	irq15_ctrl_o		,
...
assign irq0_ctrl_o =  irq0_ctrl_w[31:16]; 
assign irq1_ctrl_o =  irq1_ctrl_w[31:16]; 
assign irq2_ctrl_o =  irq2_ctrl_w[31:16]; 
assign irq3_ctrl_o =  irq3_ctrl_w[31:16]; 
assign irq4_ctrl_o =  irq4_ctrl_w[31:16]; 
assign irq5_ctrl_o =  irq5_ctrl_w[31:16]; 
assign irq6_ctrl_o =  irq6_ctrl_w[31:16]; 
assign irq7_ctrl_o =  irq7_ctrl_w[31:16]; 
assign irq8_ctrl_o =  irq8_ctrl_w[31:16]; 
assign irq9_ctrl_o =  irq9_ctrl_w[31:16]; 
assign irq10_ctrl_o= irq10_ctrl_w[31:16]; 
assign irq11_ctrl_o= irq11_ctrl_w[31:16];
assign irq12_ctrl_o= irq12_ctrl_w[31:16];
assign irq13_ctrl_o= irq13_ctrl_w[31:16];
assign irq14_ctrl_o= irq14_ctrl_w[31:16];
assign irq15_ctrl_o= irq15_ctrl_w[31:16];
...
assign soc_ack_int_id_o = ack_int_id_w ;
endmodule
