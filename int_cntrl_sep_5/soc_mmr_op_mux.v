...
output  [7 :0] 		soc_mmr_read_data_o	

);
  
  reg [7:0]  soc_mmr_read_data_r;
...
16'h9000:soc_mmr_read_data_r = soc_cfg_i	     ;   		
16'h9004:soc_mmr_read_data_r = soc_info_i		 ;  
16'h9008:soc_mmr_read_data_r = soc_nxtp_i        ;  	
16'h900C:soc_mmr_read_data_r = soc_ack_int_id_i	 ;	
16'h9010:soc_mmr_read_data_r = soc_eoi_i[7:0]	 ;
16'h9014:soc_mmr_read_data_r = irq0_ctrl_i[7 : 0];	
16'h9018:soc_mmr_read_data_r = irq0_ctrl_i[15: 8];      
16'h901C:soc_mmr_read_data_r = irq0_ctrl_i[23:16];      
16'h9020:soc_mmr_read_data_r = irq0_ctrl_i[31:24];
16'h9024:soc_mmr_read_data_r = irq1_ctrl_i[7 : 0];      
16'h9028:soc_mmr_read_data_r = irq1_ctrl_i[15: 8];      
16'h902C:soc_mmr_read_data_r = irq1_ctrl_i[23:16];      
16'h9030:soc_mmr_read_data_r = irq1_ctrl_i[31:24];
16'h9034:soc_mmr_read_data_r = irq2_ctrl_i[7 : 0];      
16'h9038:soc_mmr_read_data_r = irq2_ctrl_i[15: 8];      
16'h903C:soc_mmr_read_data_r = irq2_ctrl_i[23:16];      
16'h9040:soc_mmr_read_data_r = irq2_ctrl_i[31:24];
16'h9044:soc_mmr_read_data_r = irq3_ctrl_i[7 : 0];      
16'h9048:soc_mmr_read_data_r = irq3_ctrl_i[15: 8];      
16'h904C:soc_mmr_read_data_r = irq3_ctrl_i[23:16];      
16'h9050:soc_mmr_read_data_r = irq3_ctrl_i[31:24];
16'h9054:soc_mmr_read_data_r = irq4_ctrl_i[7 : 0];      
16'h9058:soc_mmr_read_data_r = irq4_ctrl_i[15: 8];      
16'h905C:soc_mmr_read_data_r = irq4_ctrl_i[23:16];      
16'h9060:soc_mmr_read_data_r = irq4_ctrl_i[31:24];
16'h9064:soc_mmr_read_data_r = irq5_ctrl_i[7 : 0];      
16'h9068:soc_mmr_read_data_r = irq5_ctrl_i[15: 8];      
16'h906C:soc_mmr_read_data_r = irq5_ctrl_i[23:16];      
16'h9070:soc_mmr_read_data_r = irq5_ctrl_i[31:24];
16'h9074:soc_mmr_read_data_r = irq6_ctrl_i[7 : 0];      
16'h9078:soc_mmr_read_data_r = irq6_ctrl_i[15: 8];      
16'h907C:soc_mmr_read_data_r = irq6_ctrl_i[23:16];      
16'h9080:soc_mmr_read_data_r = irq6_ctrl_i[31:24];
16'h9084:soc_mmr_read_data_r = irq7_ctrl_i[7 : 0];      
16'h9088:soc_mmr_read_data_r = irq7_ctrl_i[15: 8];      
16'h908C:soc_mmr_read_data_r = irq7_ctrl_i[23:16];      
16'h9090:soc_mmr_read_data_r = irq7_ctrl_i[31:24];
16'h9094:soc_mmr_read_data_r = irq8_ctrl_i[7 : 0];      
16'h9098:soc_mmr_read_data_r = irq8_ctrl_i[15: 8];      
16'h909C:soc_mmr_read_data_r = irq8_ctrl_i[23:16];      
16'h90A0:soc_mmr_read_data_r = irq8_ctrl_i[31:24];
16'h90A4:soc_mmr_read_data_r = irq9_ctrl_i[7 : 0];      
16'h90A8:soc_mmr_read_data_r = irq9_ctrl_i[15: 8];      
16'h90AC:soc_mmr_read_data_r = irq9_ctrl_i[23:16];      
16'h90B0:soc_mmr_read_data_r = irq9_ctrl_i[31:24];
16'h90B4:soc_mmr_read_data_r = irq10_ctrl_i[7 : 0];	
16'h90B8:soc_mmr_read_data_r = irq10_ctrl_i[15: 8];	
16'h90BC:soc_mmr_read_data_r = irq10_ctrl_i[23:16];	
16'h90C0:soc_mmr_read_data_r = irq10_ctrl_i[31:24];
16'h90C4:soc_mmr_read_data_r = irq11_ctrl_i[7 : 0];	
16'h90C8:soc_mmr_read_data_r = irq11_ctrl_i[15: 8];	
16'h90CC:soc_mmr_read_data_r = irq11_ctrl_i[23:16];	
16'h90D0:soc_mmr_read_data_r = irq11_ctrl_i[31:24];
16'h90D4:soc_mmr_read_data_r = irq12_ctrl_i[7 : 0];	
16'h90D8:soc_mmr_read_data_r = irq12_ctrl_i[15: 8];	
16'h90DC:soc_mmr_read_data_r = irq12_ctrl_i[23:16];	
16'h90E0:soc_mmr_read_data_r = irq12_ctrl_i[31:24];
16'h90E4:soc_mmr_read_data_r = irq13_ctrl_i[7 : 0];	
16'h90E8:soc_mmr_read_data_r = irq13_ctrl_i[15: 8];	
16'h90EC:soc_mmr_read_data_r = irq13_ctrl_i[23:16];	
16'h90F0:soc_mmr_read_data_r = irq13_ctrl_i[31:24];
16'h90F4:soc_mmr_read_data_r = irq14_ctrl_i[7 : 0];	
16'h90F8:soc_mmr_read_data_r = irq14_ctrl_i[15: 8];	
16'h90FC:soc_mmr_read_data_r = irq14_ctrl_i[23:16];	
16'h9100:soc_mmr_read_data_r = irq14_ctrl_i[31:24];
16'h9104:soc_mmr_read_data_r = irq15_ctrl_i[7 : 0];	
16'h9108:soc_mmr_read_data_r = irq15_ctrl_i[15: 8];	
16'h910C:soc_mmr_read_data_r = irq15_ctrl_i[23:16];	
16'h9110:soc_mmr_read_data_r = irq15_ctrl_i[31:24];
...
default: soc_mmr_read_data_r = 8'd0 ;	

endcase
end

assign soc_mmr_read_data_o = soc_mmr_read_en_i ? soc_mmr_read_data_r : 8'd0 ;
endmodule
