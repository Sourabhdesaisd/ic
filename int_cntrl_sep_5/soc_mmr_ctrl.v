...
assign  irq0_ctrl_o =  irq0_ctrl_w;
assign  irq1_ctrl_o =  irq1_ctrl_w;
assign  irq2_ctrl_o =  irq2_ctrl_w;
assign  irq3_ctrl_o =  irq3_ctrl_w;
assign  irq4_ctrl_o =  irq4_ctrl_w;
assign  irq5_ctrl_o =  irq5_ctrl_w;
assign  irq6_ctrl_o =  irq6_ctrl_w;
assign  irq7_ctrl_o =  irq7_ctrl_w;
assign  irq8_ctrl_o =  irq8_ctrl_w;
assign  irq9_ctrl_o =  irq9_ctrl_w;
assign irq10_ctrl_o = irq10_ctrl_w;
assign irq11_ctrl_o = irq11_ctrl_w;
assign irq12_ctrl_o = irq12_ctrl_w;
assign irq13_ctrl_o = irq13_ctrl_w;
assign irq14_ctrl_o = irq14_ctrl_w;
assign irq15_ctrl_o = irq15_ctrl_w;

localparam EXCEPTION_ON = 1'b1;
assign soc_int_en_o = {irq15_ctrl_w[8],irq14_ctrl_w[8],irq13_ctrl_w[8],irq12_ctrl_w[8],irq11_ctrl_w[8],irq10_ctrl_w[8],irq9_ctrl_w[8],irq8_ctrl_w[8],irq7_ctrl_w[8],irq6_ctrl_w[8],irq5_ctrl_w[8],irq4_ctrl_w[8],irq3_ctrl_w[8],irq2_ctrl_w[8],irq1_ctrl_w[8],irq0_ctrl_w[8]};
...
begin
	...
	begin
		...
		begin
			soc_ie_mmr <= {7'd0,soc_mmr_write_data[0]};global_int_enable_bit
		end
...
begin
	...
	begin
        soc_ctl_mmr <= soc_ctl_mmr; 
    end

end


//assign      soc_attr_mmr = EXC_ID_VAL;
//assign      soc_ctl_mmr = LVL_PR_VAL;
...
begin
	...
	begin
		...
		begin
			soc_ctl_mmr <= soc_mmr_write_data;
		end
	end
