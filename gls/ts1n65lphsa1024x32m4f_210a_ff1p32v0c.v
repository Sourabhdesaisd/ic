...
//*        Library Name     : ts1n65lphsa1024x32m4f (user specify : TS1N65LPHSA1024X32M4F)
//*        Library Version  : 210a
//*        Generated Time   : 2026/08/28, 23:02:00
//*******************************************************************************
`celldefine
...
specparam tckl = 0.218;
specparam tckh = 0.186;
specparam tcyc = 0.813;

specparam tas = 0.161;
specparam tah = 0.034;
specparam tds = 0.132;
specparam tdh = 0.059;
specparam tcebs = 0.218;
specparam tcebh = 0.025;
specparam twebs = 0.144;
specparam twebh = 0.021;
specparam tbwebs = 0.140;
specparam tbwebh = 0.006;
specparam tbists = 0.161;
specparam tbisth = 0.000;
specparam tams = 0.161;
specparam tamh = 0.034;
specparam tdms = 0.132;
specparam tdmh = 0.059;
specparam tcebms = 0.218;
specparam tcebmh = 0.025;
specparam twebms = 0.144;
specparam twebmh = 0.021;
specparam tbwebms = 0.140;
specparam tbwebmh = 0.006;
...
// CLK-2-Q
specparam tcd = 0.514;
specparam thold = 0.496;

// AWT(AWT)
specparam tawtq = 0.235;
specparam tawtqh = 0.122;
// AWT(BWEB)
specparam tbwq = 0.235;
specparam tbwqh = 0.122;
// AWT(D)
specparam tdq = 0.357;
specparam tdqh = 0.175;
