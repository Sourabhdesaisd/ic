...
always@(posedge soc_clk or negedge soc_rst) begin
    ...
    else if (soc_mmr_read_en_i) begin
        trace_event_int_o   <= MMR_READ;
        trace_data_int_o    <= {8'd0,soc_mmr_read_data_w[7:0],soc_mmr_read_addr_i};
    end
    else if (soc_mmr_write_en_i) begin
        trace_event_int_o   <= MMR_WRITE;
        trace_data_int_o    <= {8'd0,soc_mmr_write_data_i[7:0],soc_mmr_write_addr_i};
    end
